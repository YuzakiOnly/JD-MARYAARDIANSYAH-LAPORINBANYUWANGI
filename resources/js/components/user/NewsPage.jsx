...
export const NewsPage = ({ laporans, categories, statuses, kecamatans, filters }) => {
    ...
    const updateFilters = debounce((search, category, status, kecamatan) => {
        router.get(
            "/berita-laporan",
            { search, category, status, kecamatan },
            {
                preserveState: true,
                replace: true,
            }
    ...
    useEffect(() => {
        updateFilters(searchTerm, selectedCategory, selectedStatus, selectedKecamatan);
    }, [searchTerm, selectedCategory, selectedStatus, selectedKecamatan]);
